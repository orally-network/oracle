export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    get_subscription: IDL.Func([IDL.Nat, IDL.Nat], [GetSubscriptionResponse], []),
    ...
    start_subscription: IDL.Func([IDL.Nat, IDL.Nat, IDL.Text, IDL.Text], [Error], []),
    stop_subscription: IDL.Func([IDL.Nat, IDL.Nat, IDL.Text, IDL.Text], [Error], []),
    ...
    update_chain_fee_and_symbol: IDL.Func([IDL.Nat, IDL.Nat, IDL.Text], [Error], []),
    update_chain_min_balance: IDL.Func([IDL.Nat, IDL.Nat], [Error], []),
    update_chain_multicall_contract: IDL.Func([IDL.Nat, IDL.Text], [Error], []),
