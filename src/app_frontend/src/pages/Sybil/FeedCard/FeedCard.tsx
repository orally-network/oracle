...
const FeedCard = ({ feed }: FeedCardProps) => {
  ...
  if (data && data.length !== 0) {
    const feed = data[0].data.DefaultPriceFeed ?? data[0].data.CustomPriceFeed ?? data[0].data.CustomNumber;
    ...
    >
      <Space size="small" direction="vertical" style={{ width: '100%' }}>
        <div className={styles.header}>
          ...
          {feed_type.hasOwnProperty('Custom') || feed_type.hasOwnProperty('CustomNumber') && (
            <div
