export const idlFactory = ({ IDL }) => {
  ...
  const GetSaveAllowedChainsResponse = IDL.Vec(IDL.Tuple(IDL.Nat64, SaveAllowedChain));
  ...
  return IDL.Service({
    add_allowed_chain: IDL.Func([IDL.Nat64, IDL.Text, IDL.Text, IDL.Opt(IDL.Text)], [Error], []),
    add_allowed_erc20_tokens: IDL.Func([IDL.Nat64, IDL.Vec(ERC20Contract)], [Error], []),
    add_chain_rpc: IDL.Func([IDL.Nat64, IDL.Text, IDL.Opt(IDL.Text)], [Error], []),
    add_to_balances_whitelist: IDL.Func([IDL.Vec(IDL.Text)], [Error], []),
    add_to_whitelist: IDL.Func([IDL.Text], [Error], []),
    allow_domain: IDL.Func([IDL.Text, IDL.Text, IDL.Text, IDL.Text], [Error], []),
    ban_domain: IDL.Func([IDL.Text, IDL.Text, IDL.Text, IDL.Text], [Error], []),
    change_public_status: IDL.Func([IDL.Text, IDL.Bool, IDL.Text, IDL.Text], [Error], []),
    ...
    deposit: IDL.Func([IDL.Nat64, IDL.Text, IDL.Opt(IDL.Text), IDL.Text, IDL.Text], [Error], []),
    ...
    get_allowed_domains: IDL.Func([IDL.Text, IDL.Text], [GetAllowedDomainsResponse], []),
    ...
    grant: IDL.Func([IDL.Text, IDL.Opt(IDL.Nat64), IDL.Text, IDL.Text], [Error], []),
    ...
    remove_allowed_erc20_tokens: IDL.Func([IDL.Nat64, IDL.Vec(IDL.Text)], [Error], []),
    ...
    update_request_limit: IDL.Func([IDL.Text, IDL.Nat64, IDL.Text, IDL.Text], [Error], []),
